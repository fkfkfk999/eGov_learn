...
function fn_egov_select(seqno) {
    document.getElementById("listForm").seqno.value = seqno;
...
<div id="content_pop">
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
		 				<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.seqno}"/>')"><c:out value="${result.seqno}"/></a>&nbsp;</td>
								<td align="center" class="listtd"><c:out value="${result.title}"/>&nbsp;</td>
								<td align="center" class="listtd"><c:out value="${result.subtitle}"/>&nbsp;</td>
